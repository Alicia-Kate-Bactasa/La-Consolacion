...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['complete_sale'])) {
    ...
    try {
        ...
        $pdo->commit();
        header("Location: admin-orders.php?success=walkin");
        exit();
...
<body class="min-h-screen">
    ...
    <main class="flex-1 p-8 ml-72 h-[calc(100vh-80px)] overflow-y-auto">
        <div class="max-w-2xl mx-auto">
            <div class="mb-8 flex items-center justify-between">
                <h1 class="text-4xl font-bold text-gray-800">Walk-In Order</h1>
                <a href="admin-orders.php" class="p-2 hover:bg-gray-100 rounded-full transition"><i data-lucide="x" class="w-8 h-8 text-gray-400"></i></a>
            </div>
