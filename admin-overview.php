  ...
  <body class="min-h-screen overflow-hidden">
    ...
    <div class="flex h-[calc(100vh-80px)] overflow-hidden">
      ...
      <aside class="fixed top-[80px] left-0 w-72 h-[calc(100vh-80px)] glass p-6 border-r border-gray-200 overflow-y-auto">
        <nav class="space-y-2">
          <a href="admin-overview.php" class="w-full flex items-center space-x-3 px-4 py-3 rounded-xl text-left gradient-deep-blue text-white shadow-lg">
      ...
      <main class="flex-1 p-8 ml-72 overflow-y-auto h-[calc(100vh-80px)]">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div class="relative overflow-hidden bg-gradient-to-br from-rose-400 via-rose-500 to-rose-600 rounded-2xl p-6 text-white shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
            ...
            <div class="relative z-10">
              ...
              <div class="space-y-2">
                <a href="admin-orders.php" class="block text-base text-white hover:text-rose-100 transition-colors duration-200 font-semibold drop-shadow-md">View Orders</a>
                <a href="admin-inventory.php" class="block text-base text-white hover:text-rose-100 transition-colors duration-200 font-semibold drop-shadow-md">Manage Products</a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="bg-white/80 rounded-2xl shadow-lg p-8 mb-8">
          <div class="flex items-center justify-between mb-4">
            ...
            <a href="admin-logs.php" class="text-blue-600 hover:underline font-medium">View All Logs</a>
          </div>
          <div class="space-y-4">
